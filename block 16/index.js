...
console.log(`Your grand total is $`,Checkcustomer(timmy));
console.log(`Your grand total is $`,Checkcustomer(sarah));
console.log(`Your grand total is $`,Checkcustomer(rocky));
